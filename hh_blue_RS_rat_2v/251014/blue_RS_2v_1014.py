...
neuron_data_1 = {0: {0: {'spike_time': [],
                 ...
                 3: {0: {'spike_time': [],
                         ...
                         'spike_reset': [],
                         'width': []}},
                 4: {0: {'spike_time': [0.06525000184774399],
                         'spike_amp': [4.47041654586792],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}},
                 5: {0: {'spike_time': [0.05339999869465828],
                         'spike_amp': [4.524225234985352],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}},
                 6: {0: {'spike_time': [0.05209999904036522],
                         'spike_amp': [4.584586143493652],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}},
                 7: {0: {'spike_time': [0.05169999971985817],
                         'spike_amp': [4.613464832305908],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}},
                 8: {0: {'spike_time': [0.051500000059604645],
                         'spike_amp': [4.617727756500244],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}},
                 9: {0: {'spike_time': [0.05139999836683273],
                         'spike_amp': [4.632091999053955],
                         'spike_num': 1,
                         'spike_reset': [],
                         'width': [16]}}
                 }
